...
function toggleHamburgerMenuSecondary(hamburgerButton) {
  ...
  const navItemsModal = [
    ...
    {
      id: "portafolio",
      href: hrefLang + (currentLang === "en" ? "/portfolio.html" : "/portafolio.html"),
    ...
    {
      id: "contacto",
      href: hrefLang + (currentLang === "en" ? "/contact.html" : "/contacto.html"),
